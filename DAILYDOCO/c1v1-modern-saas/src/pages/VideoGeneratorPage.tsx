      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Create professional documentation videos in seconds. Our AI analyzes your workflow and automatically generates titles and descriptions.
          </p>
        </motion.div>
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Real-time processing with instant title and description generation.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Smart content analysis generates perfect titles and descriptions.
            </p>
          </div>
        </motion.div>
      </div>
